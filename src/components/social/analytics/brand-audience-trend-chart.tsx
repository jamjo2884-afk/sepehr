...
import type { SocialBrandTrend } from '@/types/social';
...
interface BrandAudienceTrendChartProps {
  trends: SocialBrandTrend[];
}

export function BrandAudienceTrendChart({
  trends,
}: BrandAudienceTrendChartProps) {
